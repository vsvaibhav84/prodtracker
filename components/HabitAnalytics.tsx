...
export const HabitAnalytics = ({ data: initialData }: HabitAnalyticsProps) => {
  ...
  // Note: This causes a double fetch initially (parent + this), but allows local control.
  // Ideally, state should be lifted, but for this task, we'll use the hook here.
